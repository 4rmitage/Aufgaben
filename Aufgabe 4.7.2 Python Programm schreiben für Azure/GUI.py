...
class AzureVMCreator:
    ...
    def setup_variables(self):
        ...
        self.image = tk.StringVar(value="MicrosoftWindowsServer:WindowsServer:2025-datacenter-azure-edition:latest")
    ...
    def create_basic_settings_frame(self, parent):
        ...
        image_combo['values'] = ('Ubuntu2204', '2025-datacenter-azure-edition', '2025-datacenter-azure-edition-core', 
                                'Win2022Datacenter', 'Win2019Datacenter', 'CentOS85Gen2', 'Debian11')
