...
az vm create --resource-group tn_ivan_riabik --name ksdkfh --image MicrosoftWindowsServer:WindowsServer:2025-datacenter-azure-edition:latest --size Standard_D2s_v3 --admin-username adminuser --admin-password 123456m,123456m, --nics NIC_Server01 --storage-sku StandardSSD_LRS --location northeurope --no-wait
